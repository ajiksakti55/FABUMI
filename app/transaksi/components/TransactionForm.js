...
export default function TransactionForm({
  ...
  return (
    <form
      ...
      className="max-w-2xl mx-auto w-full bg-white/80 backdrop-blur-md shadow-lg rounded-2xl p-4 sm:p-6 border border-gray-100 transition-all hover:shadow-xl text-gray-800"
    >
      {/* Judul */}
      ...
      {/* === Grid untuk tampilan rapi di HP === */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select
            className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-400 outline-none transition-all bg-white text-sm sm:text-base"
            value={type}
